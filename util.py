...
class Utilitarios:
    ...
    def BuscarEstacoes(self, siglas):
        ...
        for estacao in siglas:
            ...
            link = "https://geodesy.unr.edu/NGLStationPages/stations/%s.sta"%estacao
            html = requests.get(link, timeout=30).content
